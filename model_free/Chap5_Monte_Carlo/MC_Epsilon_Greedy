...
class MC_EG:
    ...
    def MC_EG(self, max_step=30, iteration=500):       
            ...
            for _ in tqdm(range(iteration), desc="MC-EG Training"):
                #动态更新epsilon值，随着训练的进行逐渐减少探索
                ...
                for t in reversed(range(len(episode))):
                    ...
                    # 4. policy improvement: 更新策略,采用epsilon_greedy
...
if __name__ == "__main__":
    ...
    # 3. 运行 MC ES 算法
    print("开始训练...")
    final_v = solver.MC_EG(max_step=200, iteration=15000)
    
    # 4. 可视化结果
    print("训练完成，正在渲染...")
    solver.show_policy()
    solver.show_state_value(final_v)
    env.plot_title("MC EG Results")
